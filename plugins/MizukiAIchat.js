/*Codded by Phaticusthiccy | Recoded By Sisula Welgamage && Mr.Joka
Developer Mrjoka-thejaka && Sisula Welgamage
Mizuki Whatsapp User Bot
Mizuki Full Eva AI
*/
...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts Mizuki voice chat'
...
Mizuki.addCommand({on: 'text', fromMe: wk, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    if (message.message.startsWith('mizuki') && conf.FULL_EVA !== 'true') {        
...
Mizuki.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
        if (conf.FULL_EVA == 'true' && ((!message.jid.includes('-')) || (message.jid.includes('-') && 
...
Mizuki.addCommand({ pattern: 'vtalk$', desc: vtalk_dsc, dontAddCommandList: true, fromMe: wk }, (async (message, match) => {
