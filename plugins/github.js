...
if (Config.WORKTYPE == 'private') {
    ...
    Mizuki.addCommand({ pattern: 'github ?(.*)', fromMe: true, usage: USAGE, desc: PHONEDE_DESC }, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    Mizuki.addCommand({ pattern: 'github ?(.*)', fromMe: false, usage: USAGE, desc: PHONEDE_DESC }, async (message, match) => {
