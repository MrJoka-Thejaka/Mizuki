...
var vtalk_dsc = ''
var reply_eva = ''
if (conf.LANG == 'SI') vtalk_dsc = 'Mizuki සිය voice සංවාදය ආරම්භ කරයි.', reply_eva = '*ඕනෑම voice මැසේජ් එකක් Mizuki ට මෙන්ශන්  කරන්න!*'
...
var succ_off = ''
if (conf.LANG == 'SI') {
    fulleva_dsc = 'සම්පුර්ණ ක්‍රියාකාරී Eva විශේෂාංග සක්‍රීය කරයි. ඔබේ ගිණුම චැට්බෝට් එකක් බවට පත් කරන්න!'
    already_on = 'Eva කෘතීම බුද්ධිය දැනටමත් සම්පුර්ණයෙන්ම ක්‍රියාත්මකයි.'
    already_off = 'ඊවා කෘතිම බුද්ධිය දැනට අර්ධ ක්‍රියාකාරී ලෙස ක්‍රියාත්මක වේ.'
    succ_on = 'Eva සම්පූර්ණයෙන්ම ක්‍රියාකාරී ලෙස විවෘත කරන ලදී! කරුණාකර මඳක් රැඳී සිටින්න! ✅'
    succ_off = 'Eva අර්ධ ක්‍රියාකාරී ලෙස වෙනස් කරන ලදී! කරුණාකර මඳක් රැඳී සිටින්න! ☑️'
}
if (conf.LANG == 'EN') {
