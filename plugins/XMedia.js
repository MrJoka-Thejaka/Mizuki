...
if (Config.WORKTYPE == 'private') {
    ...
    Mizuki.addCommand({pattern: 'x4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3bass$', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'x2mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'spectrum', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'waves', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'frequency', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'avec', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'volumeaudio', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'cqtaudio', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3eq', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3crusher', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3reverse', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4vintage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4reverse', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4bw', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'vintageimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4enhance', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'blurimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4blur', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3pitch', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4edge', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3low', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'x2mp3', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'edgeimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'enhanceimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3volume', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'gif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'agif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'grenimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'interp ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'rainbowimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4rainbow', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'negativeimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4negative', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4art', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'artimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4stab', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4color', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'colorimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4slowmo', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Mizuki.addCommand({pattern: 'editor$', fromMe: false, desc: Lang.XMEDİA_DESC}, (async (message, match) => {
        if (Config.LANG == 'SI' || Config.LANG == 'EN') {
            await message.sendMessage('*Qᴜᴇᴇɴ ᴍɪᴢᴜᴋɪ ᴍᴇᴅɪᴀ ᴇᴅɪᴛᴏʀ*\n\n🧧විධානය: .mp4enhance\n📜විස්තරය: වීඩියෝවේ ගුණාත්මකභාවය වැඩි දියුණු කරයි.\n\n🧧විධානය: .interp\n📜විස්තරය: වීඩියෝවේ FPS වැඩි කරයි.\n\n🧧විධානය: .mp4slowmo\n📜විස්තරය: මෙන්ශන් දුන් වීඩියෝව slow-motion වීඩියෝවක් ලෙස සාදනු ලබයි.\n\n🧧විධානය: .x4mp4\n📜විස්තරය: වීඩියෝවේ ගුණාත්මකභාවය 75% කින් අඩු කරයි.\n\n🧧විධානය: .x2mp4\n📜විස්තරය: වීඩියෝවේ ගුණාත්මකභාවය 50% කින් අඩු කරයි.\n\n🧧විධානය: .gif\n📜විස්තරය: වීඩියෝව gif බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .agif\n📜විස්තරය: වීඩියෝව voiced gif බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .mp4blur\n📜විස්තරය: වීඩියෝවේ පසුබිම බොඳ කරයි.\n\n🧧විධානය: .mp4stab\n📜විස්තරය: වීඩියෝවේ කම්පනය අඩු කරයි.\n\n🧧විධානය: .mp4rainbow\n📜විස්තරය: Rainbow effect වීඩියෝ පටයට යොදයි.\n\n🧧විධානය: .mp4color\n📜විස්තරය: වීඩියෝවේ වර්ණ වඩාත් විචිත්‍ර හා අලංකාර කරයි.\n\n🧧විධානය: .mp4art\n📜විස්තරය: වීඩියෝවට Art effect එක් කරයි.\n\n🧧විධානය: .mp4negative\n📜විස්තරය: වීඩියෝවට negative filter යොදයි.\n\n🧧විධානය:.mp4vintage\n📜විස්තරය: වීඩියෝවට vintage effect යොදයි.\n\n🧧විධානය: .mp4bw\n📜විස්තරය: වීඩියෝවට black and white effect යොදයි..\n\n🧧විධානය: .mp4reverse\n📜විස්තරය: වීඩියෝව reverse කරයි.\n\n🧧විධානය: .mp4edge\n📜විස්තරය: වීඩියෝවට edge effect යොදයි.\n\n🧧විධානය: .mp4image\n📜විස්තරය: ඡායාරූපය තත්පර 5 ක වීඩියෝවක් බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .spectrum\n📜විස්තරය: ශබ්ද වල වර්ණාවලිය වීඩියෝ බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .waves\n📜විස්තරය: ශබ්දයේ තරංග පරාසය වීඩියෝ බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .frequency\n📜විස්තරය: ශබ්දයේ සංඛ්‍යාත පරාසය වීඩියෝ බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .avec\n📜විස්තරය: ශබ්දයේ histogram , වීඩියෝ බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .volumeaudio\n📜විස්තරය: ශබ්දයේ ඩෙසිබල් අගය වීඩියෝ බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .cqtaudio\n📜විස්තරය: Audio හි CQT අගය වීඩියෝ පටයක් බවට පරිවර්තනය කරයි.\n\n🧧විධානය: .mp3eq\n📜විස්තරය: ශබ්දය පැහැදිලි මට්ටමකට සකසන්න.\n\n🧧විධානය: .mp3bass\n📜විස්තරය: ශබ්දයට හානි නොකර Bass වැඩි කරයි.\n\n🧧විධානය: .mp3crusher\n📜විස්තරය: ශබ්දය විකෘති කරයි, හාස්‍ය උපදවන ලෙස සකසයි.\n\n🧧විධානය: .mp3reverse\n📜විස්තරය: ශබ්දය පිටුපසට වාදනය කරයි.\n\n🧧විධානය: .mp3pitch\n📜විස්තරය: ශබ්දය තුනී හා වේගවත් කරයි.\n\n🧧විධානය: .mp3low\n📜විස්තරය: ශබ්දය ගැඹුරු හා මන්දගාමී කරයි.\n\n🧧විධානය: .x2mp3\n📜විස්තරය: ශබ්දය එය මෙන් දෙගුණයක් වේගවත් කරයි.\n\n🧧විධානය: .mp3volume\n📜විස්තරය: ශබ්දය වැඩි කරයි.\n\n🧧විධානය: .bwimage\n📜විස්තරය: රූපයට black and white effect යොදයි.\n\n🧧විධානය: .vintageimage\n📜විස්තරය: වීඩියෝ පටයට vintage effect යොදයි.\n\n🧧විධානය: .edgeimage\n📜විස්තරය: ඡායාරූපයට edge effect යොදයි.\n\n🧧විධානය: .enhanceimage\n📜විස්තරය: ඡායාරූපය වඩාත් පැහැදිලි කරයි.\n\n🧧විධානය: .blurimage\n📜විස්තරය: ඡායාරූපයේ පසුබිම බොඳ කරයි.\n\n🧧විධානය: .grenimage\n📜විස්තරය: ඡායාරූපයට grain effect යොදයි.\n\n🧧විධානය: .negativeimage\n📜විස්තරය: ඡායාරූපය සඳහා negative filter යොදයි.\n\n🧧විධානය: .rainbowimage\n📜විස්තරය: ඡායාරූපය සඳහා Rainbow effect යොදයි.\n\n🧧විධානය: .colorimage\n📜විස්තරය: එමඟින් ඡායාරූපයේ වර්ණ වඩාත් විචිත්‍ර හා ආකර්ෂණීය බවට පත් කරයි.\n\n🧧විධානය: .artimage\n📜විස්තරය: ඡායාරූපය සඳහා art effect යොදයි.\n\nCheck GitHub for bot :- https://github.com/MrJoka-Thejaka/Mizuki');
        } else { 
            await message.sendMessage('*Qᴜᴇᴇɴ ᴍɪᴢᴜᴋɪ ᴍᴇᴅɪᴀ ᴇᴅɪᴛᴏʀ*\n\n🧧Command: *.mp4enhance*\n📜Description: Enhance video’s quality.\n\n🧧Command: *.interp*\n📜Description: Increases the FPS of the video.\n\n🧧Command: *.mp4slowmo*\n📜Description: Applies true-slowmo to non-slow motion videos.\n\n🧧Command: *.x4mp4*\n📜Description: Reduce video’s quality by 75%.\n\n🧧Command: *.x2mp4*\n📜Description: Reduce video’s quality by 50%.\n\n🧧Command: *.gif*\n📜Description:Converts video to gif.\n\n🧧Command: *.agif*\n📜Description: Converts video to voiced gif.\n\n🧧Command: *.mp4blur*\n📜Description: Blurs the background of the video.\n\n🧧Command: *.mp4stab*\n📜Description: Decreases the vibration of the video.\n\n🧧Command: *.mp4rainbow*\n📜Description: Applies a rainbow effect to video.\n\n🧧Command: *.mp4color*\n📜Description: Makes the colors of the video more vivid and beautiful.\n\n🧧Command: *.mp4art*\n📜Description: Applies a art effect to the video.\n\n🧧Command: *.mp4negative*\n📜Description: Applies a negative color filter to the video.\n\n🧧Command: *.mp4vintage*\n📜Description: Applies a nostalgic effect to video.\n\n🧧Command: *.mp4bw*\n📜Description: Applies a monochrome effect to video.\n\n🧧Command: *.mp4reverse*\n📜Description: Plays the video in reverse.\n\n🧧Command: *.mp4edge*\n📜Description: Applies a edge effect to the video.\n\n🧧Command: *.mp4image*\n📜Description: Converts photo to 5 sec video.\n\n🧧Command: *.spectrum*\n📜Description: Converts the spectrum of sound into video.\n\n🧧Command: *.waves*\n📜Description: Converts the wave range of sound to video.\n\n🧧Command: *.frequency*\n📜Description: Converts the frequency range of sound to video.\n\n🧧Command: *.avec*\n📜Description: Converts the histogram of sound to video.\n\n🧧Command: *.volumeaudio*\n📜Description: Converts the decibel value of the sound into video.\n\n🧧Command: *.cqtaudio*\n📜Description: Converts the CQT value of audio to video.\n\n🧧Command: *.mp3eq*\n📜Description: Adjusts the sound to a crystal clear level.\n\n🧧Command: *.mp3bass*\n📜Description: Increases bass without damaging the sound.\n\n🧧Command: *.mp3crusher*\n📜Description: Distorts the sound, makes ridiculous.\n\n🧧Command:*.mp3reverse*\n📜Description: Plays the sound in reverse.\n\n🧧Command: *.mp3pitch*\n📜Description: Makes the sound thinner and faster.\n\n🧧Command: *.mp3low*\n📜Description: Makes the sound deep and slower.\n\n🧧Command: *.x2mp3*\n📜Description: Makes the sound twice as fast.\n\n🧧Command: *.mp3volume*\n📜Description: Increase sound level so much.\n\n🧧Command: *.bwimage*\n📜Description: Applies a monochrome effect to image.\n\n🧧Command: *.vintageimage*\n📜Description: Applies a vinatge effect to video.\n\n🧧Command: *.edgeimage*\n📜Description: Applies a edge effect to the photo.\n\n🧧Command: *.enhanceimage*\n📜Description: Makes the photo clearer.\n\n🧧Command: *.blurimage*\n📜Description: Blurs the background of the photo.\n\n🧧Command: *.grenimage*\n📜Description: Applies grain effect to the photo.\n\n🧧Command: *.negativeimage*\n📜Description: Applies a negative color filter to the photo.\n\n🧧Command: *.rainbowimage*\n📜Description: Applies rainbow effect to the photo.\n\n🧧Command: *.colorimage*\n📜Description: It makes the colors of the photo more vivid and attractive.\n\n🧧Command: *.artimage*\n📜Description: Applies a art effect to the photo.\n\nCheck GitHub for bot : - https://github.com/MrJoka-Thejaka/Mizuki');
    ...
    Mizuki.addCommand({pattern: 'x4mp4', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'x2mp4', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4image', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'spectrum', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'waves', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'frequency', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'avec', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'volumeaudio', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'cqtaudio', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3eq', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3crusher', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3reverse', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4vintage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4reverse', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4bw', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'bwimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'vintageimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4enhance', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'blurimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4blur', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3pitch', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4edge', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3low', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'x2mp3', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'edgeimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'enhanceimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp3volume', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'gif', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'agif', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'grenimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'interp ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        if (message.reply_message === false && match[1] === '') return await message.sendMessage('*Need Video and FPS Value!*\nEx: ```.interp 100```');
        if (match[1] <= 10) return await message.sendMessage('*Low FPS Value ⚠️*\n*Please, type over 10*');
        if (match[1] >= 500) return await message.sendMessage('*High FPS Value ⚠️*\n*Please, type under 500*');
        await message.client.sendMessage(message.jid,'```Interpolating..```',MessageType.text);
        ...
        exec('ffprobe -hide_banner -loglevel fatal -show_error -show_format -show_streams -show_programs -show_chapters -show_private_data -print_format json ' + location, async (err, st, stderr) => {
            ...
            let prcs = Config.LANG == 'SI' || Config.LANG == 'EN' ? '_මෙම ක්‍රියාවලියට යම් කාලයක් ගත විය හැකිය._\n_අනුමාන කල කාලය:_ *' + time_c.time + ' Dakika*\n_සාර්ථකත්ව අනුපාතය:_ *' + value.value + '%*' : '_This process may take a while._\n_Envisaged Time:_ *' + time_c.time + ' Minute*\n_Success Rate:_ *' + value.value + '%*'
            await message.client.sendMessage(message.jid,prcs, MessageType.text);
            var dam = 10
            ffmpeg(location)
                .videoFilters(`minterpolate=fps=${match[1]}:mi_mode=mci:me_mode=bidir`)
                ...
                .on('progress', async (progress) => {
                    ...
                    while (l > 10 && dam == 10) {
                        dam = 1
                        let yon = Config.LANG == 'SI' || Config.LANG == 'EN' ? '*Completed %10!*' : '*Completed %10!*'
                        await message.client.sendMessage(message.jid,yon, MessageType.text)
                    ...
                    while (l > 30 && dam == 1) {
                        dam = 2
                        let yotuz = Config.LANG == 'SI' || Config.LANG == 'EN' ? '*Completed %30!*' : '*Completed %30!*'
                        await message.client.sendMessage(message.jid,yotuz, MessageType.text)
                    ...
                    while (l > 50 && dam == 2) {
                        dam = 3
                        let yelli = Config.LANG == 'SI' || Config.LANG == 'EN' ? '*Completed %50*' : '*Completed %50!*'
                        await message.client.sendMessage(message.jid,yelli, MessageType.text)
                    ...
                    while (l > 70 && dam == 3) {
                        dam = 4
                        let yetmis = Config.LANG == 'SI' || Config.LANG == 'EN' ? '*Completed %70!*' : '*Completed %70!*'
                        await message.client.sendMessage(message.jid,yetmis, MessageType.text)
                    ...
                    while (l > 90 && dam == 4) {
                        dam = 5
                        let vprocc = Config.LANG == 'SI' || Config.LANG == 'EN' ? '*Preparing Video..*' : '*Preparing Video..*'
                        await message.client.sendMessage(message.jid,vprocc, MessageType.text)
    ...
    Mizuki.addCommand({pattern: 'rainbowimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4rainbow', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'negativeimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4negative', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4art', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'artimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4stab', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4color', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'colorimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mp4slowmo', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('slowmo.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('slowmo.mp4'), MessageType.video, { caption: 'True Slow-Motion by *Qᴜᴇᴇɴ ᴍɪᴢᴜᴋɪ*'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
