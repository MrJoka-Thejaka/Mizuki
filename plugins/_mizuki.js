...
const Lang = Language.getString('_miuzki');

if (Config.WORKTYPE == 'private') {

    Mizuki.addCommand({ pattern: 'mizuki ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mizuki.addCommand({pattern: 'mizuki ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
