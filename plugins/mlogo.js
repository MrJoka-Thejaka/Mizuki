...
Mizuki.addCommand({ pattern: 'mlogo$', fromMe: workt, desc: desc_msg }, (async (message, match) => {
    ...
    const msg = command_cmd + '```.devil``` \n' + t1 + '_\n' + usage_cmd + '.devil Mrjoka_\n\n' +
        command_cmd + '```.bear``` \n' + desc_cmd + t2 + '_\n' + usage_cmd + '.bear Mrjoka_\n\n' +
        command_cmd + '```.wolf``` \n' + desc_cmd + t10 + '_\n' + usage_cmd + '.wolf Developer;Mrjoka_\n\n' +
        command_cmd + '```.neon```\n' + desc_cmd + t3 + '_\n' + usage_cmd + '.neon Mrjoka_\n\n' +
        command_cmd + '```.2neon``` \n' + desc_cmd + t4 + '_\n' + usage_cmd + '.2neon Mrjoka_\n\n' +
        command_cmd + '```.3neon``` \n' + desc_cmd + t18 + '_\n' + usage_cmd + '.3neon Mrjoka_\n\n' +
        command_cmd + '```.4neon``` \n' + desc_cmd + t27 + '_\n' + usage_cmd + '.4neon Mrjoka_\n\n' +
        command_cmd + '```.light``` \n' + desc_cmd + t5 + '_\n' + usage_cmd + '.light Mrjoka_\n\n' +
        command_cmd + '```.joker``` \n' + desc_cmd + t6 + '_\n' + usage_cmd + '.joker Mrjoka_\n\n' +
        command_cmd + '```.ninja``` \n' + desc_cmd + t7 + '_\n' + usage_cmd + '.ninja Developer;Mrjoka_\n\n' +
        command_cmd + '```.glitter``` \n' + desc_cmd + t8 + '_\n' + usage_cmd + '.glitter Mrjoka_\n\n' +
        command_cmd + '```.bokeh``` \n' + desc_cmd + t9 + '_\n' + usage_cmd + '.bokeh Mrjoka_\n\n' +
        command_cmd + '```.marvel``` \n' + desc_cmd + t11 + '_\n' + usage_cmd + '.marvel Developer;Mrjoka_\n\n' +
        command_cmd + '```.2marvel``` \n' + desc_cmd + t12 + '_\n' + usage_cmd + '.2marvel Developer;Mrjoka_\n\n' +
        command_cmd + '```.avengers``` \n' + desc_cmd + t13 + '_\n' + usage_cmd + '.avengers Developer;Mrjoka_\n\n' +
        command_cmd + '```.graf``` \n' + desc_cmd + t15 + '_\n' + usage_cmd + '.graf Developer;Mrjoka_\n\n' +
        command_cmd + '```.2graf``` \n' + desc_cmd + t16 + '_\n' + usage_cmd + '.2graf Developer;Mrjoka_\n\n' +
        command_cmd + '```.lion``` \n' + desc_cmd + t17 + '_\n' + usage_cmd + '.lion Developer;Mrjoka_\n\n' +
        command_cmd + '```.ice``` \n' + desc_cmd + t19 + '_\n' + usage_cmd + '.ice Mrjoka_\n\n' +
        command_cmd + '```.space``` \n' + desc_cmd + t20 + '_\n' + usage_cmd + '.space Developer;Mrjoka_\n\n' +
        command_cmd + '```.smoke``` \n' + desc_cmd + t21 + '_\n' + usage_cmd + '.smoke Mrjoka_\n\n' +
        command_cmd + '```.glow``` \n' + desc_cmd + t23 + '_\n' + usage_cmd + '.glow Mrjoka_\n\n' +
        command_cmd + '```.fire``` \n' + desc_cmd + t25 + '_\n' + usage_cmd + '.fire Mrjoka_\n\n' +
        command_cmd + '```.harry``` \n' + desc_cmd + t26 + '_\n' + usage_cmd + '.harry Mrjoka_\n\n' +
        command_cmd + '```.cup``` \n' + desc_cmd + t29 + '_\n' + usage_cmd + '.cup Mrjoka_\n\n' +
...
Mizuki.addCommand({ pattern: 'devil ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'bear ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'wolf ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'neon ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: '2neon ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'light ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'joker ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'ninja ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: 'glitter ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'bokeh ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'marvel ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: '2marvel ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: 'avengers ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: 'glitch ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: 'graf ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: '2graf ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: 'lion ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: '3neon ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'ice ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'space ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var topText, bottomText;
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Mizuki.addCommand({ pattern: 'smoke ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'glow ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
    var download = async (uri, filename, callback) => {
        await request.head(uri, async (err, res, body) => {
            await request(uri).pipe(fs.createWriteStream(filename)).on('close', callback);
        });
...
Mizuki.addCommand({ pattern: 'fire ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'harry ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: '4neon ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'cemetery ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.addCommand({ pattern: 'cup ?(.*)', fromMe: workt, dontAddCommandList: true }, (async (message, match) => {
