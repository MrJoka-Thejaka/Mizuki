...
Mizuki.applyCMD({ pattern: 'wakeup ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.TAGALL_DESC, dontAddCommandList: true }, (async (message, match) => {
...
Mizuki.applyCMD({ pattern: 'activate', fromMe: true, deleteCommand: false, desc: AS_DESC, }, (async (message, match) => {
...
Mizuki.applyCMD({ pattern: 'off', fromMe: true, delownsewcmd: false, desc: AS_DESC, }, (async (message, match) => {
