...
module.exports = {
    ...
    BYE_LOGO: process.env.BYE_LOGO === undefined ? 'https://telegra.ph/file/1f4b6cc58aa91caaa8288.jpg' : process.env.BYE_LOGO,
    WELCOME_GIF: process.env.WELCOME_GIF === undefined ? 'https://thumbsnap.com/i/nfQGh4Pf.mp4' : process.env.WELCOME_GIF,
    WELCOME_LOGO: process.env.WELCOME_LOGO === undefined ? 'https://telegra.ph/file/1f4b6cc58aa91caaa8288.jpg' : process.env.WELCOME_LOGO,
    GREETING_TYPE: process.env.GREETING_TYPE === undefined ? 'GIF' : process.env.GREETING_TYPE,
